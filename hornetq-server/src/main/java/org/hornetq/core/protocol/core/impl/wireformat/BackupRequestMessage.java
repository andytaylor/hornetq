...
public class BackupRequestMessage extends PacketImpl
{
   ...
   private HAPolicy.BACKUP_TYPE backupType;
   ...
   public BackupRequestMessage(int backupSize, String journalDirectory, String bindingsDirectory, String largeMessagesDirectory, String pagingDirectory)
   {
      ...
      backupType = HAPolicy.BACKUP_TYPE.SHARED_STORE;
   ...
   public BackupRequestMessage(int backupSize, SimpleString nodeID)
   {
      ...
      this.backupSize = backupSize;
      this.nodeID = nodeID;
      backupType = HAPolicy.BACKUP_TYPE.REPLICATED;
   }
   ...
   public void encodeRest(HornetQBuffer buffer)
   {
      ...
      if (backupType == HAPolicy.BACKUP_TYPE.SHARED_STORE)
      {
   ...
   public void decodeRest(HornetQBuffer buffer)
   {
      ...
      backupType = HAPolicy.BACKUP_TYPE.toBackupType(buffer.readByte());
      if (backupType == HAPolicy.BACKUP_TYPE.SHARED_STORE)
      {
   ...
   public HAPolicy.BACKUP_TYPE getBackupType()
   {
      return backupType;
   }
